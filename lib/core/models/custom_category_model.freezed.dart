...
// Màu sắc dưới dạng int
  ...
  @override
  String toString() {
    return 'CustomCategory(uuid: $uuid, userId: $userId, name: $name, iconName: $iconName, colorValue: $colorValue, createdAt: $createdAt, updatedAt: $updatedAt, isDefault: $isDefault)';
  }
...
abstract class _CustomCategory implements CustomCategory {
  const factory _CustomCategory(
      ...
      final bool isDefault}) = _$CustomCategoryImpl;
